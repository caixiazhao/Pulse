...
* You set a scheduler to run this code so that the dt_start and dt_end tables are dropped and recreated with the correct information on which data has been analyzed
*/
