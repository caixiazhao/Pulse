 ...
 * data from Twitter about the Spanish soccer team FC Barcelona. Using the HP Social Media Connector, you can
 ...
 *
 * The goal is to get a comprehensive visualization of who is talking about FC Barcelona, 
...
CREATE TABLE tweets(id int, created_at TIMESTAMPTZ, "user.name" VARCHAR(144), "user.screen_name" VARCHAR(144), 
"user.followers_count" INT, text VARCHAR(500), "retweeted_status.retweet_count" INT, "retweeted_status.id" INT, 
"retweeted_status.favorite_count" INT, "retweeted_status.text" VARCHAR(500), "user.location" VARCHAR(144), 
"coordinates.coordinates.0" FLOAT, "coordinates.coordinates.1" FLOAT, "entities.hashtags.0.text" VARCHAR(144), 
"entities.hashtags.1.text" VARCHAR(144), lang VARCHAR(5));
